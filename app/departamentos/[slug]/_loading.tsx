  ...
  return (
    <div className="min-h-screen p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Skeleton do Header */}
        <div className="bg-linear-to-r from-gray-300 to-gray-400 rounded-xl p-6 md:p-8 mb-6 md:mb-8 animate-pulse">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6 md:mb-8">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white rounded-xl shadow-lg p-4 md:p-6 animate-pulse"
            >
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {/* Header da tabela */}
          <div className="p-4 md:p-6 bg-linear-to-r from-blue-50 to-gray-50 border-b">
